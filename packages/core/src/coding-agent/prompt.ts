...
function describeMode(mode: Mode): string {
  if (mode === "guided") {
    return [
      ...
      "Ask lightweight architecture or flow questions as a numbered list (`1.`, `2.`, `3.`), with each question on a single line.",
      "Allow the user to answer by number (for example: `1`, `2`, `1 and 3`).",
      "Keep expected user answers tiny: ask for one short line or one short bullet.",
      "If the user says they do not know the answer, create or update LEARNING_RESEARCH.md in the repo root.",
      "In LEARNING_RESEARCH.md, append the latest user message and your latest question/explanation, then add a short research plan and a concise checkpoint summary.",
      "Use LEARNING_RESEARCH.md as the working memory for the research loop: revisit it each turn, keep clarifying until understanding is clear, and keep responses concise.",
      "Once understanding is clear and the user is ready to proceed to coding, delete LEARNING_RESEARCH.md before implementation starts.",
  ...
  if (mode === "socratic") {
    return [
      ...
      "Ask deep questions as a numbered list (`1.`, `2.`, `3.`), with each question on a single line.",
      "Allow the user to answer by number (for example: `1`, `2`, `1 and 3`).",
      "Keep expected user answers tiny: ask for one short line or one short bullet.",
      "If the user says they do not know the answer, create or update LEARNING_RESEARCH.md in the repo root.",
      "In LEARNING_RESEARCH.md, append the latest user message and your latest question/explanation, then add a short research plan and a concise checkpoint summary.",
