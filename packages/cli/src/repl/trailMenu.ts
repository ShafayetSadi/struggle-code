...
export class TrailMenu implements Component {
  private readonly list: SelectList;

  constructor(items: SelectItem[], onSelect: (item: SelectItem) => void, onCancel: () => void) {
  ...
  render(width: number): string[] {
    return renderPanel(
      "Trail Commands",
      [
        chalk.hex(P.textMuted)("Use ↑↓ to choose, Enter to run, Esc to close."),
        "",
